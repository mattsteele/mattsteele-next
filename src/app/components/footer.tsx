...
export default function Footer() {
  return (
    <footer className="flex flex-col w-full">
      ...
      <div className="bg-red-two border-b-4 border-solid border-transparent hover:border-b-gray-300 transition-colors duration-500">
      ...
      <div className="bg-red-one border-b-4 border-solid border-transparent hover:border-b-gray-300 transition-colors duration-500">
        <Link className="flex w-full justify-center pt-2 uppercase items-center " href="/about" rel="noopener noreferrer">About</Link>
      </div>

      <div className="bg-blue-two border-b-4 border-solid border-transparent hover:border-b-gray-300 transition-colors duration-500">
        <Link className="flex w-full justify-center pt-2 uppercase items-center" href="/resume" rel="noopener noreferrer">Resume</Link>
      </div>

      <div className="bg-blue-one border-b-4 border-solid border-transparent hover:border-b-gray-300 transition-colors duration-500">
      ...
      <div className="bg-gray-two border-b-4 border-solid border-transparent hover:border-b-gray-300 transition-colors duration-500">
